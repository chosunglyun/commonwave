    ...
    <header className="np-header">
        ...
        <div className="container np-logo-inner">
          <div className="np-logo-left">
            ...
            <Link href="/" className="np-logo-link desktop-hide">
              <img src="/images/logo_new.png" alt="COMMON WAVE" style={{ height: '135px', objectFit: 'contain', margin: '-20px 0' }} />
            </Link>
          ...
          <div className="np-logo-center mobile-hide">
            <Link href="/" className="np-logo-hanja-link" title="COMMON WAVE 로고">
              <img 
                ...
                alt="COMMON WAVE" 
                style={{ height: '150px', objectFit: 'contain', margin: '-25px 0' }}
              />
            </Link>
          </div>
      ...
      */}
      ...
      <style jsx>{`
        ...
        /* 권역 메뉴 */
        .np-nav-region { color: var(--primary); font-weight: 800; }
        /* 기사제보 강조 */
        .np-nav-accent {
