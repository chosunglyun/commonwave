      ...
      <div className="subscription-page">
        ...
        <div className="plans-section">
          ...
          <div className="plans-grid">
            ...
            >
              ...
              <ul className="plan-features">
                ...
                <li className="highlight">COMMON WAVE의 날 초청 및 편집진 만남</li>
              </ul>
          ...
          <p className="compare-note">
            ...
            평생 구독자는 COMMON WAVE를 처음부터 함께 만든 창간 후원인으로 영구 기록됩니다
          </p>
          ...
          <div style={{ maxWidth: '860px', margin: '2rem auto 0', padding: '1.5rem', background: '#fff', border: '1px solid var(--rule)', borderRadius: '8px' }}>
            ...
            <p style={{ margin: 0, fontSize: '13px', color: 'var(--ink2)', lineHeight: 1.6 }}>
              현재 COMMON WAVE는 카드 자동결제·간편결제를 준비 중이며, <strong>계좌이체로만 신청을 받고 있습니다.</strong><br />
        ...
        <div className="lifetime-perks">
          <div className="perks-box">
            ...
            <div className="perks-grid">
              ...
              <div className="perk-item">
                <div className="perk-icon">🪪</div>
                <div><strong style={{color:'var(--ink)'}}>명예 독자증 실물 발급</strong><br />COMMON WAVE 공식 명예 독자증을 우편 발송합니다</div>
              </div>
              <div className="perk-item">
                <div className="perk-icon">🎁</div>
              ...
              <div className="perk-item">
                <div className="perk-icon">🥂</div>
                <div><strong style={{color:'var(--ink)'}}>COMMON WAVE의 날 초청</strong><br />연 1회 후원인과 함께하는 특별한 날, 편집진과 직접 만납니다</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="form-section">
          ...
          <div className="payment-box">
            ...
            <div className="payment-account">농협 000-0000-0000-00 · COMMON WAVE언론협동조합</div>
          </div>
