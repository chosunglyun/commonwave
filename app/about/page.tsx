  ...
  return (
    <main style={{ background: '#f8fafc', minHeight: '100vh' }}>
      ...
      <section className="about-section bg-gray">
        <div className="container" style={{ maxWidth: '900px' }}>
          <h2 className="section-heading">COMMON WAVE <span className="title-hanja">茶山語報</span></h2>
          <div className="name-content">
            <p>COMMON WAVE는 한자로 <strong>茶山語報</strong>라 적습니다.<br/>
            「語」는 말씀, 「報」는 알림 — 다산 정약용 선생이 강진에서<br/>
            18년간 백성의 삶을 기록하고 잘못된 것을 바로잡았던 그 정신으로,<br/>
            COMMON WAVE는 누구의 말에도 귀 기울이고 듣는 독립언론입니다.</p>
            
            <p className="mt-4">
            「報」는 한국 언론 전통의 글자입니다.<br/>
            조선 시대의 朝報(조보), 1883년 한국 최초 신문 漢城旬報(한성순보),<br/>
            오늘날의 「日報」가 모두 「알린다」는 뜻의 報를 씁니다.<br/>
            COMMON WAVE는 <span className="hanja-highlight">譜</span>(족보·도감)가 아닌 <span className="hanja-highlight">報</span>(알림) — 정보를 모으는 매체가 아니라,<br/>
      ...
      <section className="about-section bg-white">
        <div className="container" style={{ maxWidth: '900px' }}>
          ...
          <p className="model-intro">
            COMMON WAVE는 「COMMON WAVE 언론협동조합」 형태로 운영됩니다.<br/>
            조합원이 곧 매체의 주인이며, 어떤 외부 자본도 COMMON WAVE를 소유하지 않습니다.<br/>
          ...
          <div className="greeting-grid">
            <div className="greeting-card">
              ...
              <p className="greeting-text">
                [발행인 인사말 작성 대기 중]<br/>
                독자 여러분, 안녕하십니까. COMMON WAVE는 강진·고흥·보성·장흥의 목소리를 대변하기 위해 출발한 시민 참여형 협동조합 매체입니다. 지역의 생생한 이야기를 담아내고, 시민과 함께 성장하는 따뜻한 언론이 되겠습니다.
              </p>
            </div>
            <div className="greeting-card">
        ...
        <div className="container" style={{ maxWidth: '900px' }}>
          ...
          <div className="timeline">
            ...
            <div className="timeline-item">
              ...
              <div className="timeline-content">창립총회 → COMMON WAVE 언론협동조합 창립 → 창간</div>
            </div>
            <div className="timeline-item">
