...
const GUIDE_DATA = {
  ...
  reporter: {
    ...
    steps: [
      ...
      },
      {
        step: 3,
        title: '신청서 작성',
        description: '이름(실명), 거주 지역(시,구,동), 연락처, 간단한 자기소개 작성. 사진 촬영이나 글쓰기 경험이 있으면 기재해 주세요.',
        tags: ['경력 무관', '누구나 환영']
      },
      {
        step: 4,
  ...
  faq: {
    ...
    questions: [
      ...
      {
        q: '김포, 파주, 고양, 의정부 외 지역도 제보 가능한가요?',
        a: '경기 지역 전체의 소식을 환영합니다. 다만 4개 시 중심으로 취재하고 있어 다른 지역 제보는 편집국 판단에 따라 게재 여부가 결정됩니다.'
      }
    ],
    footer: ''
  }
