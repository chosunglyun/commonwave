...
export const metadata = {
  title: '이용약관 - COMMON WAVE',
  description: 'COMMON WAVE 언론협동조합 서비스 이용 조건 및 절차를 안내해 드립니다.'
};
        ...
        <div style={{ background: 'white', padding: '3rem', borderRadius: '8px', boxShadow: '0 4px 20px rgba(0,0,0,0.05)', border: '1px solid #eee' }}>
          ...
          <div style={{ lineHeight: '1.8', color: '#333', fontSize: '1.05rem' }}>
            <section style={{ marginBottom: '2rem' }}>
              ...
              <p>이 약관은 COMMON WAVE 언론협동조합(이하 '조합')이 운영하는 인터넷신문 COMMON WAVE(www.commonwave.kr, 이하 '사이트')에서 제공하는 서비스의 이용 조건 및 절차, 이용자와 조합의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.</p>
            </section>
