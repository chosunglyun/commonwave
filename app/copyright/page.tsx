...
export const metadata = {
  title: '저작권보호정책 - COMMON WAVE',
  description: 'COMMON WAVE 언론협동조합이 제작한 모든 콘텐츠는 저작권법의 보호를 받습니다.'
};
        ...
        <div style={{ background: 'white', padding: '3rem', borderRadius: '8px', boxShadow: '0 4px 20px rgba(0,0,0,0.05)', border: '1px solid #eee' }}>
          ...
          <div style={{ lineHeight: '1.8', color: '#333', fontSize: '1.05rem' }}>
            <p style={{ marginBottom: '2rem', color: '#555' }}>
              COMMON WAVE 언론협동조합은 저작권법을 준수하며, 조합이 제작한 모든 콘텐츠의 저작권을 보호합니다.
            </p>
            ...
            <section style={{ marginBottom: '2.5rem' }}>
              ...
              <ul style={{ listStyle: 'none', paddingLeft: '0.5rem' }}>
                ...
                <li>▸ COMMON WAVE가 촬영·제작한 사진 및 영상</li>
                <li>▸ COMMON WAVE가 제작한 그래픽·인포그래픽</li>
                <li>▸ COMMON WAVE 로고 및 제호</li>
                <li>▸ 사이트 디자인 및 구성</li>
              </ul>
            </section>
            ...
            <section style={{ marginBottom: '2.5rem' }}>
              ...
              <ul style={{ listStyle: 'none', paddingLeft: '0.5rem' }}>
                ...
                <li>▸ 출처(COMMON WAVE, www.commonwave.kr)를 명시한 적절한 인용</li>
            ...
            <section style={{ marginBottom: '2.5rem' }}>
              ...
              <ul style={{ listStyle: 'none', paddingLeft: '0.5rem' }}>
                <li>▸ COMMON WAVE의 사전 동의 없는 무단 전재·복제·배포</li>
