...
export const metadata = {
  title: '청소년보호정책 - COMMON WAVE',
  description: 'COMMON WAVE 언론협동조합은 청소년의 건전한 성장을 위해 유해정보 차단 및 보호정책을 준수합니다.'
};
        ...
        <div style={{ background: 'white', padding: '3rem', borderRadius: '8px', boxShadow: '0 4px 20px rgba(0,0,0,0.05)', border: '1px solid #eee' }}>
          ...
          <div style={{ lineHeight: '1.8', color: '#333', fontSize: '1.05rem' }}>
            <p style={{ marginBottom: '2rem', color: '#555' }}>
              COMMON WAVE 언론협동조합은 청소년보호법에 따라 청소년에게 유해한 정보가 유통되지 않도록 다음과 같은 청소년보호정책을 운영합니다.
            </p>
            ...
            <section style={{ marginBottom: '2.5rem' }}>
              ...
              <p style={{ marginBottom: '0.5rem' }}>COMMON WAVE는 다음과 같은 유해 정보가 게시되지 않도록 관리합니다.</p>
