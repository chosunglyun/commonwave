...
export const metadata = {
  title: '편집 윤리규정 - COMMON WAVE',
  description: 'COMMON WAVE는 투명하고 공정한 보도를 위해 편집 윤리규정을 준수합니다.'
};
        ...
        <div className="ethics-paper">
          <div className="ethics-header">
            <div className="header-text">
              <div className="subtitle">COMMON WAVE는 아래 윤리규정을 준수합니다</div>
          ...
          <div className="ethics-footer-stamp" style={{ justifyContent: 'center', marginTop: '4rem', fontWeight: 'bold', fontSize: '1.2rem' }}>
            <span>COMMON WAVE 언론협동조합 이사장</span>
          </div>
        </div>
      </div>

      <footer className="ethics-page-footer">
        © 2026 COMMON WAVE All rights reserved. <br/>
