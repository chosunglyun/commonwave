...
const FAQ_ITEMS = [
  {
    q: "글을 못 써도 정말 괜찮나요?",
    a: "네. 마을 리포터는 글을 쓰지 않습니다. 동네에서 일어난 일을 누가·언제·어디서·무엇을·왜·어떻게 — 이 여섯 가지로 정리해 사진 한두 장과 함께 보내주시면, COMMON WAVE 편집국이 사실 확인을 거쳐 기사로 작성·발행합니다."
  },
  {
    q: "보수가 있나요?",
    a: "정기 보수와 취재 실비 정산은 없습니다. COMMON WAVE 마을 리포터는 재능나눔 모델로 운영됩니다. 대신 누적 활동에 따른 단계별 혜택(평생 구독·명함·정기 교육)과 연 1회 COMMON WAVE의 날 시상이 있습니다."
  },
  {
    q: "얼마나 자주 알려야 하나요?",
        ...
        <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '5rem 2rem' }}>
          <div style={{ maxWidth: '600px', width: '100%', textAlign: 'center', background: 'white', padding: '4rem 2rem', borderRadius: '24px', boxShadow: '0 10px 40px rgba(0,0,0,0.05)' }}>
            ...
            <p style={{ fontSize: '1.1rem', color: '#475569', lineHeight: 1.6, marginBottom: '2rem' }}>
              COMMON WAVE 마을 리포터에 지원해주셔서 진심으로 감사드립니다.<br />
      ...
      <section style={{ background: '#1F5946', color: 'white', padding: '6rem 2rem', textAlign: 'center' }}>
        <div className="container" style={{ maxWidth: '800px' }}>
          ...
          <p style={{ fontSize: '1.25rem', opacity: 0.9, lineHeight: 1.6, wordBreak: 'keep-all' }}>
            글은 COMMON WAVE가 씁니다. 마을 리포터 모집 —<br/>
        ...
        <div className="container" style={{ maxWidth: '1000px' }}>
          ...
          <div className="benefits-grid">
            ...
            <div style={{ background: 'white', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)' }}>
              <div style={{ background: '#B22222', color: 'white', padding: '1.5rem', textAlign: 'center' }}>
                ...
                <span style={{ fontSize: '0.85rem', opacity: 0.8 }}>연례 시상 (COMMON WAVE의 날)</span>
              </div>
              <ul style={{ padding: '1.5rem', margin: 0, listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '1rem', fontSize: '0.95rem', color: '#334155' }}>
                <li>• 우수 리포터 표창</li>
          ...
          <div style={{ background: '#fffbeb', border: '1px solid #fcd34d', padding: '2rem', borderRadius: '12px', textAlign: 'center' }}>
            ...
            <p style={{ margin: 0, color: '#92400e', lineHeight: 1.6, fontSize: '0.95rem', wordBreak: 'keep-all' }}>
              COMMON WAVE 마을 리포터는 재능나눔으로 운영되며, <strong>정기 보수(월급)와 취재 실비 정산은 없습니다.</strong><br className="hidden md:block"/>
              위 혜택은 보수의 대체가 아니라, 함께 신문을 만드시는 분에게 COMMON WAVE가 드릴 수 있는 도구·연결·인정의 표시입니다.
            </p>
          </div>
        </div>
      </section>

      {/* § 6. COMMON WAVE가 책임집니다 */}
      <section style={{ padding: '5rem 2rem', background: 'white' }}>
        <div className="container" style={{ maxWidth: '700px', textAlign: 'center' }}>
          <h2 style={{ fontSize: '1.8rem', fontWeight: 800, marginBottom: '1.5rem', color: '#0f172a' }}>COMMON WAVE가 책임집니다</h2>
          <p style={{ fontSize: '1.05rem', lineHeight: 1.8, color: '#334155', wordBreak: 'keep-all' }}>
            여러분이 보내주신 제보를 바탕으로 편집국이 사실 확인을 거쳐 기사를 작성·발행합니다. 발행된 기사에 대한 모든 법적 책임 — 명예훼손 항의, 손해배상 청구, 정정 요청 등 — 은 COMMON WAVE 편집국이 집니다. 마을 리포터께서는 동네에서 일어난 일을 사실대로 알려주시기만 하면 됩니다.<br/><br/>
        ...
        <div className="container" style={{ maxWidth: '800px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            {[
              ...
              { step: '3', title: '등록 완료', desc: 'COMMON WAVE 마을 리포터로 정식 등록됩니다. COMMON WAVE 제보 페이지에서 본인 정보 자동 입력으로 빠르고 편하게 제보하실 수 있습니다.' },
