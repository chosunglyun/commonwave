...
export const metadata = {
  title: '개인정보처리방침 - COMMON WAVE',
  description: 'COMMON WAVE 언론협동조합은 이용자의 개인정보를 소중히 보호합니다.'
};
        ...
        <div style={{ background: 'white', padding: '3rem', borderRadius: '8px', boxShadow: '0 4px 20px rgba(0,0,0,0.05)', border: '1px solid #eee' }}>
          ...
          <div style={{ lineHeight: '1.8', color: '#333', fontSize: '1.05rem' }}>
            <p style={{ marginBottom: '2rem', color: '#555' }}>
              COMMON WAVE 언론협동조합(이하 '조합')은 개인정보보호법에 따라 이용자의 개인정보 보호 및 권익을 보호하고 개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 다음과 같은 처리방침을 두고 있습니다.
            </p>
