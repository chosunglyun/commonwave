        ...
        <section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
            ...
            <div style={{ background: '#fff', padding: '2.5rem 2rem', borderRadius: '16px', border: '1px solid #e2e8f0', position: 'relative' }}>
              ...
              <button style={{ width: '100%', background: 'var(--primary-light)', color: 'var(--primary)', padding: '1rem', borderRadius: '8px', fontWeight: 800, border: 'none', cursor: 'pointer' }}>선택하기</button>
            </div>
            ...
            <div style={{ background: 'var(--primary)', color: '#fff', padding: '2.5rem 2rem', borderRadius: '16px', position: 'relative', transform: 'scale(1.05)', zIndex: 10, boxShadow: '0 20px 40px rgba(27,58,107,0.2)' }}>
              ...
              <button style={{ width: '100%', background: 'var(--accent)', color: 'var(--primary-dark)', padding: '1rem', borderRadius: '8px', fontWeight: 800, border: 'none', cursor: 'pointer' }}>선택하기</button>
            </div>
            ...
            <div style={{ background: '#fff', padding: '2.5rem 2rem', borderRadius: '16px', border: '1px solid #e2e8f0', position: 'relative' }}>
              ...
              <button style={{ width: '100%', background: 'var(--primary)', color: '#fff', padding: '1rem', borderRadius: '8px', fontWeight: 800, border: 'none', cursor: 'pointer' }}>선택하기</button>
            </div>
